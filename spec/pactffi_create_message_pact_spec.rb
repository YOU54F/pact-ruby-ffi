...
RSpec.describe 'pactffi_new_message spec' do
  describe 'with matching requests' do
    ...
    let(:message)  {PactRubyFfi.pactffi_new_message(message_pact, 'Book (id fb5a885f-f7e8-4a50-950f-c1a64a94d500) created message')}
    ...
    before do
      ...
      PactRubyFfi.pactffi_with_request(interaction, 'PUT', '/api/books/fb5a885f-f7e8-4a50-950f-c1a64a94d500/generate-cover')
      PactRubyFfi.pactffi_with_header(interaction, PactRubyFfi::FfiInteractionPart['INTERACTION_PART_REQUEST'], 'Content-Type', 0, 'application/json')
      PactRubyFfi.pactffi_with_body(interaction, PactRubyFfi::FfiInteractionPart['INTERACTION_PART_REQUEST'], 'application/json', '[]')
      ...
      PactRubyFfi.pactffi_message_expects_to_receive(message, 'Book (id fb5a885f-f7e8-4a50-950f-c1a64a94d500) created message')
